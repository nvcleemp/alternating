...
/* This program reads planar graphs and filters those out that are vertex alternating.
 * 
 * 
 * Compile with:
 *     
...
void help(char *name) {
    fprintf(stderr, "The program %s reads planar graphs and filters those out that are vertex alternating.\n\n", name);
